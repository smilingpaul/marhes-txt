...
#define partstFIRST_IO			( ( unsigned portLONG ) 0x00200000 )
#define partstNUM_LEDS			( 1 )
#define partstALL_OUTPUTS_OFF	( ( unsigned portLONG ) 0x00200000 )
