...
{
	PCONP |= PCADC;
	PCLKSEL0 |= PCLKSEL0_ADC_DIV8;		// Make PCLK for ADC 48MHz / 8 = 6MHz
	// Enable A/D function on AD0.3,5,6
	PINSEL0 |= PINSEL0_AD06;
	PINSEL1 |= PINSEL1_AD03;
	PINSEL3 |= PINSEL3_AD05;
	AD0INTEN &= ~AD0INTEN_ADGINTEN;		// Turn off global A/D interrupt

	// Sample AD0.3,5,6, Have A/D clk be 100kHz = 6MHz / 60, use burst mode w/ 11 clks
	AD0CR = AD0CR_SEL3 | AD0CR_SEL5 | AD0CR_SEL6 |
			AD0CR_CLKDIV60 | AD0CR_BURST | AD0CR_CLKS11;
	AD0CR |= AD0CR_PDN;
}
